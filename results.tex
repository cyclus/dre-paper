...
\begin{figure}
  \begin{center}
    \includegraphics[width=\columnwidth]{outage_invs.pdf}
    \caption[]{
      \label{fig:prefs}
...
\begin{figure}
  ...
  \begin{minipage}{0.67\textwidth}
    \centering
    \subfloat[A]{\includegraphics[height=0.3\textheight]{outage_invs_a.pdf}}
    \vfill
    \subfloat[B]{\includegraphics[height=0.3\textheight]{outage_invs_b.pdf}}
  \end{minipage}%
  \begin{minipage}{0.33\textwidth}
    \centering
    \subfloat[C]{\includegraphics[height=0.6\textheight]{outage_invs_c.pdf}}
  \end{minipage}%
  \caption[]{
    \label{fig:prefs}
    Facility inventories in Outage scenario.}
