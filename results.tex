...
Figure \ref{fig:moxflow} showcases the cumlative flow of MOX fuel into all
...
obsevered in the \external scenario. This is due to a reduction in the available
...
heuristic cases for clairity). Differences in simulation time are observed, as
...
between the two solvers. This is due to timesteps in which there is problem
