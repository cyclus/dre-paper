...
features can be observed in Figureb\ref{fig:moxflow} dealing with departures
...
\begin{figure}
  ...
  \begin{minipage}{\textwidth}
    \centering
    \subfloat[UOX flow.]{\includegraphics[width=\textwidth]{uox_flow.pdf}}
    \label{fig:uoxflow}
    \vfill
    \subfloat[MOX flow]{\includegraphics[width=\textwidth]{mox_flow.pdf}}
    \label{fig:moxflow}
  \end{minipage}%
  \caption[]{
    \label{fig:flows}
