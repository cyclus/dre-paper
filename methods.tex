...
statement in \secref{abm:dre:prob}. It then details the methodology for querying
supply and demand during the information gathering phase of the DRE in 
\secref{abm:dre:info}. The solution phase, in which the defined DRE is translated
into a form of the Multicommodity Transportation Problem (MCTP) and solved, is
then described in \secref{abm:dre:fctp}. Finally, two proof of principle
simulations with novel fuel cycle DREs are presented in \secref{abm:dre:proof}.
...
As stated previously in \secref{abm:abm:limits}, a number of considerations must
