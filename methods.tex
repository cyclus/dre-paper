...
through it's agent communication framework. The methodology and framework can
therefore be adapted to other complex supply chains.
...
The DRE has been implemented in and serves as the functional bedrock of the
Cyclus fuel cycle simulator. It defines the interaction mechanisms and
methodologies for agents. Accordingly, Cyclus simulations are described in
\secref{results} that showcase novel enabling features. A short overview of
archetypes used in these simulations is provided in
